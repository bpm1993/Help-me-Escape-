...
extern "C"  Vector3_t4282066566  Transform_get_localEulerAngles_m3489183428 (Transform_t1659122786 * __this, const MethodInfo* method)
{
	...
	memset(&V_0, 0, sizeof(V_0));
	{
		Quaternion_t1553702882  L_0 = Transform_get_localRotation_m3343229381(__this, /*hidden argument*/NULL);
		V_0 = L_0;
...
{
	{
		...
		Transform_set_localRotation_m3719981474(__this, L_1, /*hidden argument*/NULL);
		return;
	}
}
