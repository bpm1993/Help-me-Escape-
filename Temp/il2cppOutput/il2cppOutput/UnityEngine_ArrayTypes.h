...
// UnityEngine.PolygonCollider2D[]
struct PolygonCollider2DU5BU5D_t313525459  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) PolygonCollider2D_t2156524054 * m_Items[1];

public:
	inline PolygonCollider2D_t2156524054 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline PolygonCollider2D_t2156524054 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, PolygonCollider2D_t2156524054 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
...
// UnityEngine.GameObject[,]
struct GameObjectU5BU2CU5D_t2662109049  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) GameObject_t3674682005 * m_Items[1];
...
public:
	...
	inline GameObject_t3674682005 * GetAt(il2cpp_array_size_t i, il2cpp_array_size_t j) const
	{
		il2cpp_array_size_t index = i * bounds[1].length + j;
		return m_Items[index];
	}
	inline GameObject_t3674682005 ** GetAddressAt(il2cpp_array_size_t i, il2cpp_array_size_t j)
	{
		il2cpp_array_size_t index = i * bounds[1].length + j;
		return m_Items + index;
	}
	inline void SetAt(il2cpp_array_size_t i, il2cpp_array_size_t j, GameObject_t3674682005 * value)
	{
		il2cpp_array_size_t index = i * bounds[1].length + j;
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
